...
import showcase1Front from "../../assets/images/content/showcase-1.front.jpg";
import showcase1Back from "../../assets/images/content/showcase-1.back.jpg";
import showcase1Rear from "../../assets/images/content/showcase-1.rear.jpg";
import showcase1Side from "../../assets/images/content/showcase-1.side.jpg";
import showcase1Top from "../../assets/images/content/showcase-1.top.jpg";

export default function ProductDetails() {
  const [preview, setPreview] = useState({
    imgSelected: showcase1Front,
  });

  const handleclick = (imgPreview) => {
    setPreview({
          ...
          <div className="slider">
            <div className="thumbnail">
              <div className="px-2">
                <div
                  className={
                    preview.imgSelected === showcase1Front
                      ? "item selected"
                      : "item"
                  }
                  data-img={showcase1Front}
                  onClick={() => handleclick(showcase1Front)}
                >
                  <img
                    src={showcase1Front}
                    alt="front"
              ...
              <div className="px-2">
                <div
                  className={
                    preview.imgSelected === showcase1Back
                      ? "item selected"
                      : "item"
                  }
                  data-img={showcase1Back}
                  onClick={() => handleclick(showcase1Back)}
                >
                  <img
                    src={showcase1Back}
                    alt="back"
              ...
              <div className="px-2">
                <div
                  className={
                    preview.imgSelected === showcase1Rear
                      ? "item selected"
                      : "item"
                  }
                  data-img={showcase1Rear}
                  onClick={() => handleclick(showcase1Rear)}
                >
                  <img
                    src={showcase1Rear}
                    alt="rear"
              ...
              <div className="px-2">
                <div
                  className={
                    preview.imgSelected === showcase1Side
                      ? "item selected"
                      : "item"
                  }
                  data-img={showcase1Side}
                  onClick={() => handleclick(showcase1Side)}
                >
                  <img
                    src={showcase1Side}
                    alt="side"
              ...
              <div className="px-2">
                <div
                  className={
                    preview.imgSelected === showcase1Top
                      ? "item selected"
                      : "item"
                  }
                  data-img={showcase1Top}
                  onClick={() => handleclick(showcase1Top)}
                >
                  <img
                    src={showcase1Top}
                    alt="top"
